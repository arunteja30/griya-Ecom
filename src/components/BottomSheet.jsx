...
export default function BottomSheet({ isOpen = false, onClose = () => {}, children }) {
  return (
    <div
    ...
    >
      ...
      <div className="relative bg-white rounded-t-lg shadow-lg p-4 max-w-3xl mx-auto">
        <div className="flex items-start justify-between">
          <div className="text-lg font-semibold">Added to cart</div>
