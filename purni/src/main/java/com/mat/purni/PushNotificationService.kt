...
class PushNotificationService : FirebaseMessagingService() {
    ...
    companion object {
        ...
        const val ACTION_FOREGROUND_NOTIFICATION = "com.mat.purni.FOREGROUND_NOTIFICATION"
    }
    ...
    private fun sendNotification(
        ...
        val channelId = "customer_app_notifications"
        ...
        val notificationBuilder = NotificationCompat.Builder(this, channelId)
            ...
            .setAutoCancel(true)
            .setSound(if (isForeground) null else defaultSoundUri)
