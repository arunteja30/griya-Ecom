...
class PushNotificationService : FirebaseMessagingService() {
    ...
    companion object {
        ...
        const val ACTION_FOREGROUND_NOTIFICATION =
            "com.example.deliveryhybrid.FOREGROUND_NOTIFICATION"
    }
    ...
    private fun sendNotification(
        ...
        val intent = Intent(this, HybridWebActivity::class.java).apply {
            ...
            if (orderId != null) {
                putExtra("orderId", orderId)
                putExtra("deepLink", "/active-delivery/$orderId")
            }
        }
    ...
    private fun saveFCMToken(userId: String, token: String) {
        ...
        val userRef = database.getReference("deliveryPartners").child(userId)
        ...
        userRef.updateChildren(tokenData)
