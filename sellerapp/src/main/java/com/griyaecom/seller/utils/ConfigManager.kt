...
object ConfigManager {
     ...
     */
    object Defaults {
        const val CUSTOMER_URL = "https://griyamart.onrender.com"
    ...
    suspend fun getCustomerWebUrl(): String =
        getConfigValue(Paths.CUSTOMER_WEB_URL, Defaults.CUSTOMER_URL)

    suspend fun getSellerWebUrl(): String =
        getConfigValue(Paths.SELLER_WEB_URL, Defaults.SELLER_URL)

    suspend fun getDeliveryWebUrl(): String =
        getConfigValue(Paths.DELIVERY_WEB_URL, Defaults.DELIVERY_URL)
}
